...
/**
 * pint_handler - will handle the pint instruction
 ...
 * @line_number: The number of lines in the file
 */
...
/**
 * swap_handler - Will handle the swap instruction
...
/**
 * add_handler - Will handle the add instruction
 * @stack: Double pointer to the stack to push to
 * @line_number: Number of lines i the file
 */
...
/**
 * nop_handler - Will handle the nop instruction
 * @stack: Double pointer to the stack to push to
