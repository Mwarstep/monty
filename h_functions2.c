...
/**
 * sub_handler - will handle the subinstruction
...
/**
 * div_handler - will handle the div instruction
 * @stack: Double pointer to the stack to push to
 * @line_number: Number of lines in file
 */
...
/**
 * mul_handler - Will handle the mul instruction
 * @stack: Double pointer to the stack to push to
...
/**
 * mod_handler - will handle the mod instruction
 * @stack: Double pointer to the stack to push to
 * @line_number: Number of the line in file
 */
